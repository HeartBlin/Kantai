...
{
  flake.modules.nixos.vscode = moduleWithSystem ({ self', ... }: { config, pkgs, ... }: let
    settingsJSON = builtins.toJSON {
      ...
      "notebook.codeActionsOnSave"."notebook.source.fixAll.ruff" = true;
      "notebook.codeActionsOnSave"."notebook.source.organizeImports.ruff" = true;
