...
in {
  ...
  "secrets/ovh/endpoint.age".publicKeys = [ heartblin Reason ];
  "secrets/ovh/application-key.age".publicKeys = [ heartblin Reason ];
  "secrets/ovh/application-secret.age".publicKeys = [ heartblin Reason ];
  "secrets/ovh/consumer-key.age".publicKeys = [ heartblin Reason ];
}
